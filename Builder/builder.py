...
class FlowGraph(Graph):
  ...
  def _resolveFlowGraph(self):
    ...
    for flowObject in self._flowSpecBase:
      ...
      # assumes "sdfRequired" appears in the context of Object definitions
  ...
  # ObjectFlow target only needs the ObjectID, ResourceID, Data Type, and Data initializer
  # ObjectFlow resources are only containers for data values
  # ObjectFlow Objects "know" about their required resources
  # for each resource. Each Object is initialized when a new ID is encountered in the list
  #
  # instances.h
  # // Generated by ObjectFlow builder 
